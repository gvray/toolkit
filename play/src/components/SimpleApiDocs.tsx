...
import { apiData, type ApiFunction, type KitApi } from '../data/apiData'

const SimpleApiDocs: React.FC = () => {
  ...
  const currentKit = apiData[selectedKit]
  const filteredFunctions =
    currentKit?.functions.filter(
      (func) =>
