...
describe('walkTree', () => {
    ...
    it('should walk through all nodes in depth-first order', () => {
      const tree: TreeNode[] = [
        createNode(1, 'Root', [
          ...
          createNode(3, 'Child 2', [createNode(4, 'Grandchild')]),
        ]),
      ];
  ...
  describe('stopping traversal', () => {
    it('should stop traversal when visitor returns false', () => {
      const tree: TreeNode[] = [
        createNode(1, 'Root', [
          createNode(2, 'Child 1'),
          createNode(3, 'Child 2'),
          createNode(4, 'Child 3'),
        ]),
      ];
    ...
    it('should continue traversal when stopOnFalse is false', () => {
      const tree: TreeNode[] = [
        createNode(1, 'Root', [createNode(2, 'Child 1'), createNode(3, 'Child 2')]),
      ];
  ...
  describe('level and index parameters', () => {
    it('should pass correct level and index to visitor function', () => {
      const tree: TreeNode[] = [
        createNode(1, 'Root', [
          createNode(2, 'Child 1', [createNode(4, 'Grandchild')]),
          createNode(3, 'Child 2'),
        ]),
      ];
